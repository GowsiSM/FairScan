...
export default function Upload({ onResult, onBack }: Props) {
  ...
  const [analysisType, setAnalysisType] = useState<"dataset" | "model">(
    "dataset",
  );
    ...
    <div className="upload-page">
      ...
      <div className="upload-layout">
            ...
            {[
              {
                num: 1,
                label: "Context",
                click: () => step !== 1 && setStep(1),
                clickable: step !== 1,
              },
              {
                num: 2,
                label: "Analysis",
                click: () => step > 2 && setStep(2),
                clickable: step > 2,
              },
              {
                num: 3,
                label: "Dataset",
                click: () => step > 3 && setStep(3),
                clickable: step > 3,
              },
              {
                num: 4,
        ...
        <main className={`upload-main step-${step}-active`}>
            ...
            <div className="domain-grid">
              ...
              >
                ...
                <span className="domain-hint">
                  Analyze raw dataset for historical bias
                </span>
              </button>
              <button
              ...
              >
                ...
                <span className="domain-hint">
                  Analyze model outputs for predictive bias
                </span>
              </button>
            </div>
          </section>
                ...
                {analysisType === "dataset" ? (
                  ...
                  <div className="model-instructions">
                    ...
                    <ol className="instruction-list">
                      ...
                      <li>
                        Run your model on the downloaded CSV to generate
                        predictions.
                      </li>
          ...
          {/* Step 4 — Columns */}
          <section
            className={`step-block ${step === 4 ? "current" : "pending"}`}
          >
            <div className="step-meta">
            ...
            <div className="fields">
              ...
              <div className="field-row">
                <label
                  className={`field ${analysisType === "model" ? "half" : ""}`}
                >
                  <span className="field-label">
                    {analysisType === "model"
                      ? "Ground truth column"
